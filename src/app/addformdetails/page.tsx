...
export default function RegisterVisitPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-top py-8">
      <h1 className="text-2xl mb-4 w-full text-left pl-16">Register a new Visit</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-7xl">
        <div className="flex flex-wrap -mx-4 mb-8">
          ...
          <div className="w-full md:w-1/2 px-4 mb-4">
            ...
            <select {...register("visitDuration")} className="w-full p-2 border rounded">
          ...
          <div className="w-full md:w-1/2 px-4 mb-4">
            ...
            <select {...register("entryPoint")} className="w-full p-2 border rounded">
              <option value="">--select--</option>
